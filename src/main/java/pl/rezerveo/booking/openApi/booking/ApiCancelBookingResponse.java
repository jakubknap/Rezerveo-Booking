...
@Operation(
        ...
        description = "Pozwala użytkownikowi anulować swoją rezerwację. Jeżeli nie ma innych potwierdzonych rezerwacji na slot, slot stanie się ponownie dostępny",
        responses = {
                @ApiResponse(
                        responseCode = "200",
                ...
                @ApiResponse(
                        responseCode = "403",
                        description = "Użytkownik nie jest właścicielem rezerwacji",
                        content = @Content(
                                schema = @Schema(implementation = BaseResponse.class),
                                examples = @ExampleObject(
                                        value = """
                                                {
                                                    "status": "E06003",
                                                    "message": "Logged in user is not the owner of the booking",
                                                    "httpStatus": "FORBIDDEN",
                                                    "traceId": "2bb8723b-9eb9-4b96-a8a0-441552a28977"
                                                }
                                                """
                                )
                        )
                ...
                @ApiResponse(
                        responseCode = "404",
                        description = "Rezerwacja o podanym UUID nie istnieje",
                        content = @Content(
                                schema = @Schema(implementation = BaseResponse.class),
                                examples = @ExampleObject(
                                        value = """
...
public @interface ApiCancelBookingResponse {}